...
public class PaytmDetailPojo {
		...
		public PaytmDetailPojo(String merchantId, String channelId, String website,
		...
		public String toString() {
			return "PaytmDetailPojo [merchantId=" + merchantId  + ", channelId=" + channelId
